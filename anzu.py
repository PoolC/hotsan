...
def process(r):
    ...
    def impl(bot, message: 'message'):
        try:
            ...
            elif message.get('text', '').startswith('안즈쨩 기억해') or message.get('text', '').startswith('안즈 기억'):
            ...
            elif message.get('text', '').startswith('안즈쨩 알려줘') or message.get('text', '').startswith('안즈 알려줘'):
